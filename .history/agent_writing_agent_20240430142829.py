...
print(create_system_prompt("Please create a system prompt for an agent that can schedule in focused time blocks for a student", "This student wants to plan for 4 hour blocks ))